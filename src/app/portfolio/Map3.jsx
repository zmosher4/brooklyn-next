    ...
    <div id={id} className="sm:m-4">
      ...
      <div className="flex items-center justify-center sm:m-4">
        <iframe
          ...
          frameborder="0"
          className="overflow-auto w-[75%] h-[700px] border-none sm:p-8"
        ></iframe>
      </div>
      <div className="text-[#30574e] font-light leading-relaxed md:mx-64 md:my-20 m-4 text-xl">
